...
const OfferLetterInput = () => {
  ...
  function handleView() {
    if (name == '' || day == '' || month == '' || year == '' || position == '' || period == '' || post == '' || stipend == '') {
      ...
      navigate(`/offer-letter-intern-view?${queryParams}`);
    }
  }
  ...
  function handleDownload() {
    if (name == '' || day == '' || month == '' || year == '' || position == '' || period == '' || post == '' || stipend == '') {
      ...
      navigate(`/offer-letter-intern-download?${queryParams}`);
    }
  }
    ...
    <>
      ...
      <div className="w-full flex justify-center items-center ">
        <div className="bg-white rounded-xl ml-8 w-2/4 mt-8 py-10 flex flex-col justify-center items-center shadow-[0_2px_10px_rgba(0,0,0,0.3)]">
          <h1 className="font-medium text-black text-2xl mb-8 uppercase text-center">Offer Letter Form for Intern</h1>
