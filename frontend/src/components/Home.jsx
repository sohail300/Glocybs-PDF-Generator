      ...
      <div className=' flex flex-col justify-center items-center'>
        <div className=" bg-white rounded-xl ml-8 w-2/4 py-8 mt-20 shadow-[0_2px_10px_rgba(0,0,0,0.3)]">
          ...
          <div className=' w-40 m-auto'>
            <div className=' cursor-pointer rounded-lg bg-outerspace text-black py-2 px-4 text-center mb-8 font-medium text-lg outline-none shadow-sm shadow-black uppercase' onClick={() => navigate('/offer-letter-input')}>Offer Letter</div>
