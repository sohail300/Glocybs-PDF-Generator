...
const EmployeeHandbookInput = () => {
  ...
  function handleView() {
    ...
    if (!(regex.test(name)) || name === "") {
      ...
      navigate(`/employee-handbook-view?${queryParams}`);
    }
  }
  ...
  function handleDownload() {
    ...
    if (!(regex.test(name)) || name === "") {
      ...
      navigate(`/employee-handbook-download?${queryParams}`);
    }
  }
    ...
    <>
      ...
      <div className="w-full flex justify-center items-center ">
        <div className="bg-white rounded-xl ml-8 w-2/4 py-12 mt-20 flex flex-col justify-center items-center shadow-[0_2px_10px_rgba(0,0,0,0.3)]">
          <h1 className="font-medium text-black text-2xl mb-8 uppercase text-center">Employee Handbook Form</h1>
...
export default EmployeeHandbookInput