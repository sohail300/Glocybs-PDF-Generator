        ...
        <View style={styles.container}>
          ...
          <View style={styles.bodyContainer}>
            ...
            <View style={styles.heading}>
              <Text style={{ textAlign: 'center', marginTop: '20px' }}>EMPLOYEE NON-DISCLOSURE AGREEMENT</Text>
            </View>
            <View style={styles.content}>
              <Text>This EMPLOYEE NON-DISCLOSURE AGREEMENT, hereinafter known as the “Agreement”, is
                entered into between Sohail and Glocybs Pvt.Ltd. (“Company”), collectively known as the
            ...
            <View style={styles.content}>
              ...
              <Text>A. Definitions. Confidential Information is any material, knowledge, information and data
            ...
            <View style={styles.content}>
              <Text>B. Exclusions. For the purposes of this Agreement, information shall not be deemed
                ...
                (iii) the information was approved for release by Employer through written authorization.</Text>
            </View>
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.container}>
          ...
          <View style={styles.bodyContainer}>
            ...
            <Banner />
            <View style={styles.content}>
              <Text>C. Period of Confidentiality. (Check One)
                ...
                Company for a period of ______Lifetime_________.
                ☐ - Employee agrees not to use or disclose Confidential Information for their own
                personal benefit or the benefit of any other person, corporation or entity other than the
            ...
            <View style={styles.content}>
              <Text>D. Limitations. Employee shall limit access to Confidential Information to individuals on a
            ...
            <View style={styles.content}>
              <Text>E. Ownership. All repositories of information containing or in any way relating to Confidential
            ...
            <View style={styles.content}>
              ...
              <Text>A. Prior inventions. Any inventions created or conceptualized by the Employee prior to signing
            ...
            <View style={styles.content}>
              ...
              <Text>A. Previous Agreements. This Agreement constitutes the entire agreement and the signing
                ...
                both Parties.  3 | G l o c y b s . c o m
        ...
        <View style={styles.container}>
          ...
          <View style={styles.bodyContainer}>
            ...
            <View style={styles.content}>
              ...
              <Text>A. Non-contract. The Agreement does not constitute a contract of employment, nor does it
            ...
            <View style={styles.content}>
              ...
              <Text>This Agreement shall be governed in accordance with the laws of the State of </Text>
            </View>
            ...
            <View style={styles.content}>
              ...
              <Text>A. Cause for Action. Employee understands that the use or disclosure of any Confidential
                Information may be cause for an action at law in an appropriate court of the State of
                ____________ or any State of the India, or in any fed                                                                              - KDUNKDQG                                                                                                                                                   eral court, and that the Employer shall be
                entitled to an injunction prohibiting the use or disclosure of the Confidential Information.
